...
const CardBook = ({bookd}) => {
    const {bookName, author, image, tags,rating , category, publisher, yearOfPublishing , totalPages, id} = bookd;
    return (
        <div className="my-10 mx-4 lg:mx-0">
            <section className=" text-gray-800 border border-gray-300 py-1 px-5 rounded-2xl">
                <div className="container flex flex-col mx-auto lg:flex-row">
                    ...
                    <img src={bookd.image} alt="" className="rounded-lg shadow-lg h-80 w-80 lg:mt-8 mt-5" />
                    </div>
                    <div className="flex flex-col w-full p-6 lg:w-2/3 md:p-8 lg:p-12">
                      ...
                      <div>
                      <Link to={`/book/${id}`}>
                      <button className="bg-green-300 self-start px-5 py-2 text-sm rounded-3xl text-gray-900 hover:bg-green-600">View Details</button>
                        </Link>
                       </div>
                        </div>
                    </div>
