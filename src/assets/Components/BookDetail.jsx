...
//     const isExist = storedReadBooks.find(id => id === book.id);
...
const BookDetail = () => {
    ...
    const handleWishlist = () => {
        ...
        if (isAlreadyRead) {
            toast.error("Already in read list. Cannot add to wishlist.");
        } else {
	...
	<div className="container flex flex-col-reverse mx-auto lg:flex-row">
        ...
        <div className="flex flex-col px-6  space-y-6 rounded-sm sm:p-8 lg:p-12 lg:w-1/2 xl:w-3/6  text-gray-900">
            ...
            <div className="flex">
            <div className="mr-5">
                <a onClick={handleApplyjob} className="btn bg-green-500 hover:bg-green-700 text-white">Read</a>
                </div>
                <div>
                <a onClick={handleWishlist} className="btn bg-red-500 hover:bg-red-700 text-white">Wishlist</a>
                </div>
            </div>
            <ToastContainer />
		</div>
